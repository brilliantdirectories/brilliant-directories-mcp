...
10. **Image dedup (FEATURE).** Per METHODOLOGY Stage 5 Step 3. For blog: `listSingleImagePosts property=original_image_url property_value=<URL1,URL2,URL3> property_operator=in`.
