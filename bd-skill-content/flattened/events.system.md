...
| `post_venue` | The named place or organization hosting the event — a venue, park, school, university, base, or government body ("Stubb's BBQ", "Naval Station Norfolk", "Lincoln High School") — the name only, no city appended. No named place in the source → the geocode's named place when Nominatim returns one; else omit. |
