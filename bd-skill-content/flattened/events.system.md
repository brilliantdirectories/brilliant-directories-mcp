...
10. **Content manufacture.** Proceed straight from runbook Step 9 — no extra BD lookups. Follow METHODOLOGY `Stage 5: Content manufacture (universal)` with this file's `Content manufacture` events-specific inserts.
