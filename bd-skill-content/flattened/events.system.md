...
| `post_venue` | The proper-noun place where the event happens ("Stubb's BBQ", "Staples Center", "Delta Hotels Toronto") — the name only, no city appended. No name in the source → the geocode's named place when Nominatim returns one; else omit. |
