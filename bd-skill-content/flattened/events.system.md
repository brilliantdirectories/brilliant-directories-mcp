...
7. **Geocode.** Nominatim every address-confirmed survivor in one turn — each survivor's GEOCODING.md retry-ladder tiers batched together as backups; the lowest-numbered hit wins per survivor. Skip lat/lon on failure.
