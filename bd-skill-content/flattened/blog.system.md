...
- **Evidential subject** — the evidence for a fact as its sentence's actor, narrating the inference instead of stating the conclusion. The sentence runs backwards: evidence, inference verb, then the real fact. State the concluded fact with the thing itself as subject ("The studio is located in Wynwood").
