...
- **Offer / navigation** — any sentence, bullet, statement, callout, or clause whose function is offering, orienting, or steering rather than asserting: a reader-goal adjunct, fronted or trailing ("For a wider look...", "For a related warm up...", "for people who want...", "If X is the better match..."), plus a clause presenting a resource as available, or steering verbs (compare, browse, scan, open). Every sentence asserts a fact about the subject; the post never offers, never routes.
