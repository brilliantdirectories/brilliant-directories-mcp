...
- Every anchor sits mid-sentence, never as a sentence's first word. One that does → move the link to a mid-sentence occurrence of the phrase, or if the phrase only ever opens a sentence, capitalize that first letter (a sentence never opens lowercase).
