...
- Every voice: declarative and active. Every sentence's subject comes from a closed set — a person, an organization, a place, or the record and its concrete parts; nothing abstract ever holds the subject slot, under any verb — doing real things in literal verbs, or simply stating what a thing is ("East Bank Club is looking for trainers"; "Earthbound Yogi is a three-day retreat in Saratoga Springs") — never a motion verb faking existence ("brings a retreat to", "lands in", "turns X into"). Facts stated plainly, not hedged.
