...
- **Source links are optional + casual, not forced attribution.** When natural, the link rides a fact in flowing prose (helps Google EEAT signals). Do not require a forced attribution footer.
