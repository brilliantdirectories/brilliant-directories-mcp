...
- **Evidential subject** — the evidence for a fact as its sentence's actor, narrating the inference instead of stating the conclusion ("the address places the studio in Wynwood", "the ZIP code puts the gym on the east side"). The sentence runs backwards: evidence, inference verb, then the real fact. State the concluded fact with the thing itself as subject ("The studio sits in Wynwood").
