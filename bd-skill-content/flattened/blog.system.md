...
- Every voice: declarative and active. Every sentence's subject comes from a closed set — a person, an organization, a place, or the record and its concrete parts; nothing abstract ever holds the subject slot, under any verb — doing real things in literal verbs ("East Bank Club is looking for trainers"), or stating what a thing is ("Earthbound Yogi is a three-day retreat in Saratoga Springs", not "brings a retreat to"). Facts stated plainly, not hedged.
...
10. Three sentences in a row sharing length, an opening word, or a "The [noun]" subject? Vary one — hand the next sentence to a person, the org, or a place, or let time or place lead it. Post-wide, one noun never holds the subject slot more than three times — rotate its synonyms or hand the sentence elsewhere.
