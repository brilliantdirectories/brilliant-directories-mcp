...
- Every voice: declarative and active. Every sentence's subject comes from a closed set — a person, an organization, a place, or the record and its concrete parts; nothing abstract ever holds the subject slot, under any verb — doing real things in literal verbs ("East Bank Club is looking for trainers"), or stating what a thing is with the plain verb — "is", "is at", "runs", "opens", "costs" — never a light verb standing in for it ("sits at", "gives a role", "holds", "brings"), never acting on people or places. Facts stated plainly, not hedged.
