...
1b. Subject-and-verb scan — every sentence, before any other check below. (a) Subject a document (the page, posting, listing, site, address, schedule, source, role, job, event)? Rewrite so the fact stands alone: "The page asks for a resume" → "A resume is required"; "The program lists 90 sessions" → "90 sessions are scheduled"; "The page frames it around X" → "X is the focus". (b) Main verb a light stand-in for "is/is at" — sits, gives, holds, places, brings, keeps, offers, carries — where "is", "is at", "costs", or "opens" states the plain fact? Swap to the plain verb: "LA FORME sits at 238 N. Citrus" → "LA FORME is located at 238 N. Citrus"; "Atlanta gives the Kroc Center a city anchor" → "The Kroc Center is in Atlanta". A light verb doing real, literal work stays: "doors open at noon", "the pass costs $40". (c) Subject an abstraction — a quality or summary word (scale, format, setting, vibe, mix, value, backdrop) naming no person, org, place, or concrete part of the record, under any verb including "is"? Hand the slot to the thing itself or state the bare fact; the record itself or a concrete part of it (the festival, the gym, the booth) stays — never a word standing in for it (its schedule, program, day).
