...
- A fact restated anywhere it was already given — in another section, later in the same one, a trailing paragraph, or prose repeating a lead bullet? Tells: "as noted above", "it is worth noting", "additionally", "the date is". Cut the repeat.
