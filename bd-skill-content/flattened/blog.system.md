...
- Are H2 headings marking topic shifts, not fact transitions? Each H2 introduces meaningfully different content. Vary section length naturally — some two paragraphs, some several, some with a bulleted list. Do NOT trim source-supported depth just to keep sections compact.
- A fact restated anywhere it was already given? Tells: "as noted above", "it is worth noting", "additionally", "the date is", or prose repeating a lead bullet. Cut the repeat.
