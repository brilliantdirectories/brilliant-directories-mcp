...
- A near-identical sentence or fact (a venue, date, price, registration path) restated anywhere it was already given — including a fact already in the lead bullets re-stated in prose — its tells are "as noted above", "it is worth noting", "additionally", "the date is", re-listing logistics in a trailing paragraph? Cut the repeat.
