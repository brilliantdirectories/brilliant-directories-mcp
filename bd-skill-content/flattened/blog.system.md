...
- **False agency** — an attribute, setting, or format as benefactor: inanimate subject + causative verb + evaluative payoff ("The free format keeps the session open", "the pier setting gives the race a clear local draw", "That mix makes motion feel organized"). The object is the test: a measurable fact rides any subject ("The series runs through August"); an evaluative payoff never does — state the bare fact or who does what ("Sessions are free; all levels welcome").
