...
- **Post-type listing and directory landing** (Patterns 2 and 5): `/<data_filename>` and `/<main_directory_url_relative>` — banked at Stage 1, placed on any content phrase the draft already wrote.
