  ...
  const server = new Server(
    ...
    },
    {
      ...
      instructions: [
        ...
        ``,
        `**"SEO content for a category" = create a WebPage, NOT update the category's \`desc\`.** The \`desc\` field on Top Categories and Sub Categories is a short internal label stored on the taxonomy row — most BD themes do NOT render it on the public search-results page. Dumping SEO prose (H1, intro paragraph, meta tags, long copy) into \`desc\` writes to a dead field. For the category's public search page, create a WebPage with \`seo_type=profile_search_results\` and the matching slug (see the Member Search Results SEO pages rule below for the full recipe — country/state/city/top_cat/sub_cat slug hierarchy, required defaults, auto-generated meta). Applies equally to \`createTopCategory\`/\`updateTopCategory\`/\`createSubCategory\`/\`updateSubCategory\` — keep their \`desc\` short/optional, route SEO copy to the WebPage system.`,
        ``,
