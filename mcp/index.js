  ...
  const server = new Server(
    ...
    },
    {
      ...
      instructions: [
        ...
        ``,
        `Taxonomy — three tiers, three tool families:`,
        `• Top Categories → \`TopCategory*\` tools (BD calls them "professions" / \`list_professions\`).`,
        `• Sub Categories → \`SubCategory*\` tools (BD: "services" / \`list_services\`). Require a \`profession_id\` parent.`,
